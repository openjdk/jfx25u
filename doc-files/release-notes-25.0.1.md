...
These notes document the JavaFX 25.0.1 update release. As such, they complement the [JavaFX 25](https://github.com/openjdk/jfx25u/blob/master/doc-files/release-notes-25.md) release notes.
...
NONE[externalId "tên người dùng:jdoe"]
  accountId = 1003407
  email = jdoe@example.com
  mật khẩu = bcrypt:4:LCbmSBDivK/hhGVQMfkDpA==:XcWn0pKYSVU/UJgOvhidkEtmqCp6oKB7
